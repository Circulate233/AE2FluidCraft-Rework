...
public class DriverPartDualInterface implements DriverBlock {
    ...
    public boolean worksWith(final World world, final BlockPos pos, final EnumFacing face) {
        if (world.getTileEntity(pos) instanceof final TileCableBus cable) {
    ...
    public ManagedEnvironment createEnvironment(final World world, final BlockPos pos, final EnumFacing face) {
        final IPartHost host = (IPartHost) world.getTileEntity(pos);
    ...
    public static class Environment extends ManagedTileEntityEnvironment<IPartHost> implements NamedBlock, NetworkControl, PartEnvironmentBase {
        ...
        public Environment(final IPartHost tile, final EnumFacing side) {
            super(tile, name);
        ...
        @Override
        public <PartType extends ISegmentedInventory> Object[] getPartConfig(final Context context, final Arguments arguments, final ClassTag<PartType> classTag) {
            return PartEnvironmentBase$class.getPartConfig(this, context, arguments, classTag);
        }

        @Override
        public <PartType extends ISegmentedInventory> Object[] setPartConfig(final Context context, final Arguments arguments, final ClassTag<PartType> classTag) {
