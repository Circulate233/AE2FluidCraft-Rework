...
public class GregUtil {
    ...
    public static boolean isNotConsume(final IRecipeWrapper wrapper, final int index) {
        if (wrapper instanceof final GTRecipeWrapper gtRecipe && mGTRecipeWrapper_isNotConsumedItem != null) {
            try {
