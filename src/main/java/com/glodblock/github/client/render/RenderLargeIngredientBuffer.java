...
public class RenderLargeIngredientBuffer extends TileEntitySpecialRenderer<TileLargeIngredientBuffer> {
    ...
    @Override
    public void render(final TileLargeIngredientBuffer tile, final double x, final double y, final double z, final float partialTicks, final int destroyStage, final float alpha) {
